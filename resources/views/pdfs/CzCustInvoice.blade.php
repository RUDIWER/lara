...
<table width="100%" border="0">
    <tr>
        <td width="60%" align="left">
            <img src="{{(public_path() . '/img/cz-logo-trends.png') }}" alt="cool-zawadi"><br>
        </td>
...
<table>
  ...
  @foreach ($invoiceRows as $invoiceRow)
    <tr>
        ...
        <td align="right"> {{ $invoiceRow->quantity }} </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-right:auto;margin-left:0px">
    <tr>
        ...
        <td width="10%" border="1" valign="top" rowspan="3" align="right">
